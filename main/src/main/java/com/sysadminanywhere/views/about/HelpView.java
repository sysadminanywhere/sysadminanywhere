...
public class HelpView extends VerticalLayout implements HasDynamicTitle {
    ...
    private Card getNavigationCard() {
        ...
        addHelpItem(content, "help_view.hardware_inventory_title", "help_view.hardware_inventory_text");
    ...
    private Card getWorkflowsCard() {
        ...
        addHelpItem(content, "help_view.licenses_title", "help_view.licenses_text");
        addHelpItem(content, "help_view.issues_title", "help_view.issues_text");
