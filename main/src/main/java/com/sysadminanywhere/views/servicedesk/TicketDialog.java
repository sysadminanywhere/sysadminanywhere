...
public class TicketDialog extends Dialog {
    ...
    public TicketDialog(TicketService ticketService, TicketItem ticket, MessageSource messageSource, LocaleService localeService, Runnable onSearch) {
        ...
        TextField txtTitle = new TextField(getMessage("ticket_dialog.title"));
        ...
        TextArea txtDescription = new TextArea(getMessage("ticket_dialog.description"));
        ...
        ComboBox<String> comboStatus = new ComboBox<>(getMessage("ticket_dialog.status"));
        ...
        ComboBox<String> comboPriority = new ComboBox<>(getMessage("ticket_dialog.priority"));
        ...
        ComboBox<String> comboCategory = new ComboBox<>(getMessage("ticket_dialog.category"));
        ...
        TextField txtRequester = new TextField(getMessage("ticket_dialog.requester"));
        txtRequester.setValue(ticket.getRequester() != null ? ticket.getRequester() : "");
        txtRequester.setReadOnly(ticket.getId() != null);

        TextField txtAssignee = new TextField(getMessage("ticket_dialog.assignee"));
        ...
        TextArea txtResolution = new TextArea(getMessage("ticket_dialog.resolution"));
        ...
        if (ticket.getId() != null) {
            ...
            H3 commentsTitle = new H3(getMessage("ticket_dialog.comments"));
            layout.add(commentsTitle);
